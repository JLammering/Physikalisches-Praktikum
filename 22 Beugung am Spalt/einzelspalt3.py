...
Ispalt3 *= 1e-6
Ispalt3 -= 1.45e-9#dunkelstrom abziehen
...
params, covariance = curve_fit(f, phi, Ispalt3, p0=[6, 0.4e-3])
...
print('abweichung = ', abweichung(params[1], 0.4e-3)*100)


plt.plot(x, Ispalt3*1e6, 'kx', label = 'Messwerte')
...
plt.savefig('build/einzelspalt3.pdf')
plt.show()
